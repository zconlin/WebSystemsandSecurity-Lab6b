...
You can define properties that are need-to-know, meaning they are just a function that returns the value you want. Let's say we have a `<person>` component, and we have the birthday but not the age:
